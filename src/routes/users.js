...
const users = [
  ...
  { id: 2, name: 'Bob Smith', email: 'bob@example.com', preferences: { theme: 'light', language: 'en', notifications: true } },
  { id: 3, name: 'Charlie Lee', email: 'charlie@example.com', preferences: { theme: 'light', language: 'en', notifications: true } },
];
...
router.put('/:id/preferences', (req, res) => {
  ...
  // Validate language (ISO 639-1 format: 2 lowercase letters)
